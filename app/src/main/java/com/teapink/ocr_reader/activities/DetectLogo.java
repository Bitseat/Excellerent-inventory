...
import com.teapink.ocr_reader.tensorflow.Classifier;
...
import com.teapink.ocr_reader.tensorflow.TensorFlowImageClassifier;
...
public class DetectLogo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Request Permission
        PermissionList permission = new PermissionList(getApplicationContext(), DetectLogo.this);
